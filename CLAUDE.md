...
- There are zero phase directories under `docs/work/*/`; `mvp/` is the only delivery and holds only the v1
  roadmap, `docs/work/mvp/2026-09-05-ruby-sdk-v1-roadmap-design.md`.
