...
- There are five phase directories under `docs/work/*/`; `mvp/` is the only delivery, and it holds
  ...
  `docs/work/mvp/phase4/2026-09-08-phase4-segmentation-design.md`, and one sub-phase directory,
  `phase4/phase4a/`, holding that sub-phase's design with its plan still to be written.
