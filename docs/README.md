...
domain model, phase 2's seam layer, phase 3a's byte-streaming layer and phase 3b's body layer; the
other five are phase 0's skeletons, a namespace and a `VERSION`. The as-built documentation lands
in [`sdk-documentation/`](./sdk-documentation/) as each gem gains code; the five pages written so
far are [`sdk-documentation/quality-gates.md`](./sdk-documentation/quality-gates.md), because the
...
layer is the thing phase 3a built, and [`sdk-documentation/body.md`](./sdk-documentation/body.md),
