...
refutes — **thirty-six of thirty-nine rows red**, the same three equivalent.
...
- **Fixed in material this phase may write, not findings**: the reactor-exit hang in the driver, the
  ...
  from the watcher's close and the driver's unbounded `around:` (guard 37, deviation 42).
