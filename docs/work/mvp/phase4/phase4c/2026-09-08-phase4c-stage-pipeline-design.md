...
touch public behaviour, the contract a later phase cites, or a count this document states.
...
P4-50–P4-57 into design §10, and the §5.1 and §5.3 addenda that would state the `(stage, key)` map,
