...
| `IO-34` | SHOULD | 🚫 | — | Discovery caching for the retired seam (design §10.1; appendix-C only) [level corrected 2026-09-25 by phase 10: appendix C gives `IO-34` as SHOULD; this row said MUST] |
| `IO-35` | SHOULD | 🚫 | — | The late-replacement warning for the retired seam (design §10.1; appendix-C only) |
| `IO-36` | MAY | 🚫 | — | The provider's own conformance obligations for the retired seam (design §10.1) [level corrected 2026-09-25 by phase 10: appendix C gives `IO-36` as MAY; this row said MUST] |
